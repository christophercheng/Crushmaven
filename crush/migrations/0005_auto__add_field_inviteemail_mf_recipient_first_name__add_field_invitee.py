...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InviteEmail.mf_recipient_first_name'
        db.add_column(u'crush_inviteemail', 'mf_recipient_first_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InviteEmail.mf_recipient_fb_username'
        db.add_column(u'crush_inviteemail', 'mf_recipient_fb_username',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InviteEmail.mf_recipient_first_name'
        db.delete_column(u'crush_inviteemail', 'mf_recipient_first_name')

        # Deleting field 'InviteEmail.mf_recipient_fb_username'
        db.delete_column(u'crush_inviteemail', 'mf_recipient_fb_username')
