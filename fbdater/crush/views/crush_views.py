...
from fbdater.crush.models import CrushRelationship, PlatonicRelationship, FacebookUser, InviteEmail  # ,LineupMember
import json
import datetime
from fbdater.crush.appinviteform import AppInviteForm
from fbdater.crush.appinviteformv2 import AppInviteForm2
import time
...
def ajax_load_response_dialog_content(request, crush_id):
    ...
    if relationship.target_status == 4:
        ...
        if relationship.target_platonic_rating != None:
            ajax_response += "<span class='response_message'>" + crush.get_gender_pronoun_subject() + " did however assess your attractiveness:</span>"
