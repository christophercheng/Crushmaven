...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrushRelationship.cadence_mf_date_last_sent'
        db.add_column(u'crush_crushrelationship', 'cadence_mf_date_last_sent',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CrushRelationship.cadence_mf_num_sent'
        db.add_column(u'crush_crushrelationship', 'cadence_mf_num_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrushRelationship.cadence_mf_date_last_sent'
        db.delete_column(u'crush_crushrelationship', 'cadence_mf_date_last_sent')

        # Deleting field 'CrushRelationship.cadence_mf_num_sent'
        db.delete_column(u'crush_crushrelationship', 'cadence_mf_num_sent')
    ...
    models = {
        ...
        'crush.crushrelationship': {
            ...
            'cadence_mf_date_last_sent': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'cadence_mf_num_sent': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'crush.inviteemail': {
            ...
            'num_times_sent': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
