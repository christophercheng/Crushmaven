        ...
        return render(request, 'guest_home.html',
                          {
                           ...
                           'change_description': "Flirtally is a new matchmaking service for people who already have someone in mind - for themselves or friends of theirs. Log in to see who " + first_name + " recommended.",
                           })    
    else:
            return render(request, 'guest_home.html',
                              {
