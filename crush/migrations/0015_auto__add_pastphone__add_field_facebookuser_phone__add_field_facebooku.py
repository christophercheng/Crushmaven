...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PastPhone'
        db.create_table(u'crush_pastphone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('date_phone_invite_last_sent', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crush.FacebookUser'])),
        ))
        db.send_create_signal('crush', ['PastPhone'])

        # Adding field 'FacebookUser.phone'
        db.add_column(u'crush_facebookuser', 'phone',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookUser.date_phone_invite_last_sent'
        db.add_column(u'crush_facebookuser', 'date_phone_invite_last_sent',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PastPhone'
        db.delete_table(u'crush_pastphone')

        # Deleting field 'FacebookUser.phone'
        db.delete_column(u'crush_facebookuser', 'phone')

        # Deleting field 'FacebookUser.date_phone_invite_last_sent'
        db.delete_column(u'crush_facebookuser', 'date_phone_invite_last_sent')
