...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CrushRelationship.target_platonic_rating'
        db.delete_column(u'crush_crushrelationship', 'target_platonic_rating')


    def backwards(self, orm):
        # Adding field 'CrushRelationship.target_platonic_rating'
        db.add_column(u'crush_crushrelationship', 'target_platonic_rating',
