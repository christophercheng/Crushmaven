...
def context_processor(request):
    ...
    if not me.is_anonymous():  
        ...
        progressing_admirer_relationships = me.crush_relationship_set_from_target.filter(date_lineup_finished=None).exclude(source_person__in = progressing_crush_list,is_lineup_initialized=False) # valid progressing relationships  
