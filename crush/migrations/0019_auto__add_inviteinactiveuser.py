...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InviteInactiveUser'
        db.create_table(u'crush_inviteinactiveuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invite_inactive_person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crush.FacebookUser'])),
        ))
        db.send_create_signal('crush', ['InviteInactiveUser'])


    def backwards(self, orm):
        # Deleting model 'InviteInactiveUser'
        db.delete_table(u'crush_inviteinactiveuser')
