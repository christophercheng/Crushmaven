...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrushRelationship.lineup_auto_completed'
        db.add_column(u'crush_crushrelationship', 'lineup_auto_completed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrushRelationship.lineup_auto_completed'
        db.delete_column(u'crush_crushrelationship', 'lineup_auto_completed')
