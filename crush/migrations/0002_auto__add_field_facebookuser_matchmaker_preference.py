...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.matchmaker_preference'
        db.add_column(u'crush_facebookuser', 'matchmaker_preference',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.matchmaker_preference'
        db.delete_column(u'crush_facebookuser', 'matchmaker_preference')
    ...
    models = {
        ...
        'crush.facebookuser': {
            ...
            'matchmaker_preference': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
