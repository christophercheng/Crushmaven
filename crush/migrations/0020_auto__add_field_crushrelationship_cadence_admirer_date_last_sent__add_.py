...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrushRelationship.cadence_admirer_date_last_sent'
        db.add_column(u'crush_crushrelationship', 'cadence_admirer_date_last_sent',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CrushRelationship.cadence_admirer_num_sent'
        db.add_column(u'crush_crushrelationship', 'cadence_admirer_num_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CrushRelationship.cadence_crush_date_last_sent'
        db.add_column(u'crush_crushrelationship', 'cadence_crush_date_last_sent',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CrushRelationship.cadence_crush_num_sent'
        db.add_column(u'crush_crushrelationship', 'cadence_crush_num_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrushRelationship.cadence_admirer_date_last_sent'
        db.delete_column(u'crush_crushrelationship', 'cadence_admirer_date_last_sent')

        # Deleting field 'CrushRelationship.cadence_admirer_num_sent'
        db.delete_column(u'crush_crushrelationship', 'cadence_admirer_num_sent')

        # Deleting field 'CrushRelationship.cadence_crush_date_last_sent'
        db.delete_column(u'crush_crushrelationship', 'cadence_crush_date_last_sent')

        # Deleting field 'CrushRelationship.cadence_crush_num_sent'
        db.delete_column(u'crush_crushrelationship', 'cadence_crush_num_sent')
    ...
    models = {
        ...
        'crush.crushrelationship': {
            ...
            'cadence_admirer_date_last_sent': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'cadence_admirer_num_sent': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'cadence_crush_date_last_sent': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'cadence_crush_num_sent': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'crush.facebookuser': {
            ...
            'bCompletedSurvey': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'date_phone_invite_last_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'site_credits': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'crush.inviteinactiveuser': {
            'Meta': {'object_name': 'InviteInactiveUser'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_inactive_person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crush.FacebookUser']"})
        },
        'crush.lineupmember': {
        ...
        'crush.platonicrelationship': {
            ...
            'rating_comment': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
