...
def crushlist(request):
    ...
    response = "<h2>" + relevant_relationship_list.count() + " Inactive Users Who Haven't Been Twitter Invited:</h1><BR>"
    for relationship in relevant_relationship_list:
        response += relationship.source_person.get_name() + "(<a target='_blank' href='www.facebook.com/" + relationship.source_person.username + "'>" + relationship.source_person.username + "</a>)    ----->    " + relationship.target_person.get_name() + "(<a target='_blank' href='www.facebook.com/" + relationship.target_person.username + "'>" + relationship.target_person.username + "</a>)<BR>"
