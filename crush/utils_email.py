...
def send_mail_user_logged_in(user, header_string):
    ...
    if user.username not in ['100006341528806','1057460663','100004192844461','651900292','100003843122126','100007405598756']:
        ...
        send_mailgun_email('CrushMaven <notifications@crushmaven.com>','admin@crushmaven.com',user.get_name() + ' logged in!',message,message)
        send_mailgun_email('CrushMaven <notifications@crushmaven.com>','6465732737@vmobl.com','',user.get_name() + ' logged in! http://www.facebook.com/' + str(user.username),user.get_name() + ' logged in! http://www.facebook.com/' + str(user.username))
