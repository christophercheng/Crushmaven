...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.is_email_verified'
        db.add_column(u'crush_facebookuser', 'is_email_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.is_email_verified'
        db.delete_column(u'crush_facebookuser', 'is_email_verified')
