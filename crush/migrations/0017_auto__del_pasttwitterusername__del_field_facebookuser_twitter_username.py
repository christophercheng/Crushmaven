...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PastTwitterUsername'
        db.delete_table(u'crush_pasttwitterusername')

        # Deleting field 'FacebookUser.twitter_username'
        db.delete_column(u'crush_facebookuser', 'twitter_username')

        # Deleting field 'FacebookUser.date_twitter_invite_last_sent'
        db.delete_column(u'crush_facebookuser', 'date_twitter_invite_last_sent')

        # Adding field 'FacebookUser.date_fb_invite_last_sent'
        db.add_column(u'crush_facebookuser', 'date_fb_invite_last_sent',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'PastTwitterUsername'
        db.create_table(u'crush_pasttwitterusername', (
            ('twitter_username', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crush.FacebookUser'])),
            ('date_twitter_invite_last_sent', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('crush', ['PastTwitterUsername'])

        # Adding field 'FacebookUser.twitter_username'
        db.add_column(u'crush_facebookuser', 'twitter_username',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookUser.date_twitter_invite_last_sent'
        db.add_column(u'crush_facebookuser', 'date_twitter_invite_last_sent',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FacebookUser.date_fb_invite_last_sent'
        db.delete_column(u'crush_facebookuser', 'date_fb_invite_last_sent')
    ...
    models = {
        ...
        'crush.facebookuser': {
            ...
            'date_fb_invite_last_sent': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
