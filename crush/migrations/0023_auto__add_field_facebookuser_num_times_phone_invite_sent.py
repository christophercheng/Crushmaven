...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.num_times_phone_invite_sent'
        db.add_column(u'crush_facebookuser', 'num_times_phone_invite_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.num_times_phone_invite_sent'
        db.delete_column(u'crush_facebookuser', 'num_times_phone_invite_sent')
    ...
    models = {
        ...
        'crush.facebookuser': {
            ...
            'num_times_phone_invite_sent': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
