...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrushRelationship.date_source_last_notified'
        db.add_column(u'crush_crushrelationship', 'date_source_last_notified',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrushRelationship.date_source_last_notified'
        db.delete_column(u'crush_crushrelationship', 'date_source_last_notified')
