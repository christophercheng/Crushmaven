...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrushRelationship.date_lineup_expires'
        db.add_column(u'crush_crushrelationship', 'date_lineup_expires',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrushRelationship.date_lineup_expires'
        db.delete_column(u'crush_crushrelationship', 'date_lineup_expires')
