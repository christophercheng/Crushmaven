...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crush_facebookuser', (
            ...
            ('twitter_username', self.gf('django.db.models.fields.CharField')(default=None, max_length=15, null=True, blank=True)),
        ...
        db.create_table(u'crush_crushrelationship', (
            ...
            ('is_lineup_paid', self.gf('django.db.models.fields.BooleanField')(default=True)),
