...
class FacebookUserAdmin(admin.ModelAdmin):
    ...
    fields=('first_name','last_name','email','gender_pref','site_credits','bNotify_crush_signup_reminder','bNotify_new_admirer','processed_activated_friends_admirers','date_joined','is_active','is_staff','is_superuser','password')
