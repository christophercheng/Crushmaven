...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.is_single_test'
        db.add_column(u'crush_facebookuser', 'is_single_test',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.is_single_test'
        db.delete_column(u'crush_facebookuser', 'is_single_test')
    ...
    models = {
        ...
        'crush.facebookuser': {
            ...
            'is_single_test': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
