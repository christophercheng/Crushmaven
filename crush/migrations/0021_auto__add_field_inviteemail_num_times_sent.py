...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InviteEmail.num_times_sent'
        db.add_column(u'crush_inviteemail', 'num_times_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InviteEmail.num_times_sent'
        db.delete_column(u'crush_inviteemail', 'num_times_sent')
    ...
    models = {
        ...
        'crush.inviteemail': {
            ...
            'num_times_sent': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
