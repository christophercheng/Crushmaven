...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.bNotify_lineup_expiration_warning'
        db.add_column(u'crush_facebookuser', 'bNotify_lineup_expiration_warning',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.bNotify_lineup_expiration_warning'
        db.delete_column(u'crush_facebookuser', 'bNotify_lineup_expiration_warning')
