...
def crushlist(request):
    ...
    relevant_relationship_list = CrushRelationship.objects.filter(target_person__is_active=False,target_person__date_twitter_invite_last_sent=None).orderBy('-date_added')
