...
def send_facebook_mail_crush_invite(friendship_type,first_name,recipient_fb_username):
    ...
    if friendship_type == 0:
        send_mail(first_name + ', a Facebook friend of yours added you as their crush', "Visit https://apps.facebook.com/crushmaven to learn more.\r\n\r\nCrushMaven is the new matchmaking service that discovers anonymously if the person you're attracted to feels the same - or why they don't", 'CrushMaven <socialmedia@crushmaven.com>',[facebook_email_address])
    elif friendship_type == 1:
