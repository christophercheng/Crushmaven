...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlatonicRelationship.rating_comment'
        db.add_column(u'crush_platonicrelationship', 'rating_comment',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlatonicRelationship.rating_comment'
        db.delete_column(u'crush_platonicrelationship', 'rating_comment')
