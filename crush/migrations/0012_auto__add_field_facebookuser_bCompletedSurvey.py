...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.bCompletedSurvey'
        db.add_column(u'crush_facebookuser', 'bCompletedSurvey',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.bCompletedSurvey'
        db.delete_column(u'crush_facebookuser', 'bCompletedSurvey')
