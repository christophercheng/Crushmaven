...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookUser.matchmaker_preference'
        db.alter_column(u'crush_facebookuser', 'matchmaker_preference', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'FacebookUser.matchmaker_preference'
        db.alter_column(u'crush_facebookuser', 'matchmaker_preference', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'crush.facebookuser': {
            ...
            'matchmaker_preference': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
